...
describe('parseServiceStatus', () => {
  it('returns correct state for inactive/failed statuses', () => {
    ...
    expect(parseServiceStatus('failed')).toEqual({ state: 'failed', color: 'red', label: 'Error' });
  });
  ...
  it('returns unknown state for empty/non-string inputs', () => {
    expect(parseServiceStatus('')).toEqual({ state: 'unknown', color: 'gray', label: 'Unknown' });
    expect(parseServiceStatus(null)).toEqual({ state: 'unknown', color: 'gray', label: 'Unknown' });
    expect(parseServiceStatus(undefined)).toEqual({ state: 'unknown', color: 'gray', label: 'Unknown' });
  });
});
